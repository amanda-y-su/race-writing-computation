...
fit1 <- stan_glmer(social ~ gender + race + bible + gender:bible + race:bible + (1|title), data=data, family=binomial, refresh = 0)
fit2 <- stan_glmer(social ~ gender + race + bible + race:bible + (1|title), data=data, family=binomial, refresh = 0)
